...
// En dev sans VITE_API_URL → backend local ; sinon URL configurée (prod = Render)
const API_URL = import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000/api' : 'https://gestion-scolaire.onrender.com/api')
